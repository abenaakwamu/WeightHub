...
const contractABI = require("../artifacts/contracts/Weighthubplus.sol/Weighthubplus.json").abi;

program
    .name("weighthubplus-cli")
    .description("CLI tool for Weighthubplus smart contract")
    .version("1.0.0");
